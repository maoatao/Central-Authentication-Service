...
public class ClientGrantTypeSaveParam extends BaseSaveParam {

    @Serial
    private static final long serialVersionUID = -5541522061546287495L;
    ...
    @Tolerate
    public ClientGrantTypeSaveParam() {}
}
