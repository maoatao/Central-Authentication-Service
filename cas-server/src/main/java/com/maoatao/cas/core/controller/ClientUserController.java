...
@Tag(name = "UserController", description = "CAS 客户端用户管理")
public class ClientUserController {
    ...
    public Page<ClientUserVO> page(@Validated @RequestBody ClientUserQueryParam param) {
     ...
     */
    @PostMapping
    @CasAuth("cas_client_user_add")
    @Operation(summary = "save", description = "新增CAS 客户端用户")
    @OperationLog(type = OperationType.ADD, content = "新增CAS 客户端用户", moduleName = "cas")
    public long save(@Validated @RequestBody ClientUserSaveParam param) {
        return clientUserService.save(param);
    }
     ...
     */
    @PutMapping
    @CasAuth("cas_client_user_update")
    @Operation(summary = "update", description = "修改CAS 客户端用户")
    @OperationLog(type = OperationType.UPDATE, content = "修改CAS 客户端用户", moduleName = "cas")
    public boolean update(@Validated @RequestBody ClientUserUpdateParam param) {
        return clientUserService.update(param);
    }
     ...
     */
    @DeleteMapping("/{ids}")
    @CasAuth("cas_client_user_delete")
    @Operation(summary = "remove", description = "通过id删除CAS 客户端用户(多个 id 使用,分隔)")
    @OperationLog(type = OperationType.DELETE, content = "删除CAS 客户端用户", moduleName = "cas")
    public boolean remove(@PathVariable @Parameter(name = "ids", description = "CAS 客户端用户id集合") List<Long> ids) {
        return clientUserService.remove(ids);
    }
}
