...
public class ApprovalsScopeSaveParam extends BaseSaveParam {

    @Serial
    private static final long serialVersionUID = 4642875651035658339L;
    ...
    @Tolerate
    public ApprovalsScopeSaveParam() {}
}
