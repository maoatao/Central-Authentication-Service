...
public class ClientSettingUpdateParam extends BaseUpdateParam {

    @Serial
    private static final long serialVersionUID = 9000276919595091388L;
    /**
    ...
    @Tolerate
    public ClientSettingUpdateParam() {}
}
