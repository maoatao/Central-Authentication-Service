...
@Schema(description = "CAS 客户端重定向地址数据")
public class ClientRedirectUrlVO extends BaseVO {

    @Serial
    private static final long serialVersionUID = 8228401480890339293L;
