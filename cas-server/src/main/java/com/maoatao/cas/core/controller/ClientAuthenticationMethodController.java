...
public class ClientAuthenticationMethodController {
    ...
    @GetMapping("/{id}")
    @CasAuth("cas_clientauthenticationmethod_get")
    @Operation(summary = "details", description = "通过id查询CAS 客户端身份验证方法")
    @OperationLog(type = OperationType.QUERY, content = "查询CAS 客户端身份验证方法", moduleName = "cas")
    public ClientAuthenticationMethodVO details(@PathVariable @Parameter(name = "id", description = "CAS 客户端身份验证方法id") Long id) {
        return clientAuthenticationMethodService.details(id);
    }
     ...
     */
    @PostMapping
    @CasAuth("cas_clientauthenticationmethod_add")
    @Operation(summary = "save", description = "新增CAS 客户端身份验证方法")
    @OperationLog(type = OperationType.ADD, content = "新增CAS 客户端身份验证方法", moduleName = "cas")
    public long save(@Validated @RequestBody ClientAuthenticationMethodSaveParam param) {
        return clientAuthenticationMethodService.save(param);
    }
     ...
     */
    @PutMapping
    @CasAuth("cas_clientauthenticationmethod_update")
    @Operation(summary = "update", description = "修改CAS 客户端身份验证方法")
    @OperationLog(type = OperationType.UPDATE, content = "修改CAS 客户端身份验证方法", moduleName = "cas")
    public boolean update(@Validated @RequestBody ClientAuthenticationMethodUpdateParam param) {
        return clientAuthenticationMethodService.update(param);
    }
     ...
     */
    @DeleteMapping("/{ids}")
    @CasAuth("cas_clientauthenticationmethod_delete")
    @Operation(summary = "remove", description = "通过id删除CAS 客户端身份验证方法(多个 id 使用,分隔)")
    @OperationLog(type = OperationType.DELETE, content = "删除CAS 客户端身份验证方法", moduleName = "cas")
    public boolean remove(@PathVariable @Parameter(name = "ids", description = "CAS 客户端身份验证方法id集合") List<Long> ids) {
        return clientAuthenticationMethodService.remove(ids);
    }
}
