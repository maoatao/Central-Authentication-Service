...
public class ClientTokenSettingSaveParam extends BaseSaveParam {

    @Serial
    private static final long serialVersionUID = 7329630592065342055L;
    ...
    @Tolerate
    public ClientTokenSettingSaveParam() {}
}
