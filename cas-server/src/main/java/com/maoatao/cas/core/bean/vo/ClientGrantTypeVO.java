...
@Schema(description = "CAS 客户端授权类型数据")
public class ClientGrantTypeVO extends BaseVO {

    @Serial
    private static final long serialVersionUID = -1690667188117398443L;
