...
public class ClientRedirectUrlSaveParam extends BaseSaveParam {

    @Serial
    private static final long serialVersionUID = -6245188945208913600L;
    ...
    @Tolerate
    public ClientRedirectUrlSaveParam() {}
}
