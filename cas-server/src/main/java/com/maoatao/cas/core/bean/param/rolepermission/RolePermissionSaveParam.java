...
public class RolePermissionSaveParam extends BaseSaveParam {

    @Serial
    private static final long serialVersionUID = -3408111764261301917L;
    ...
    @Tolerate
    public RolePermissionSaveParam() {}
}
