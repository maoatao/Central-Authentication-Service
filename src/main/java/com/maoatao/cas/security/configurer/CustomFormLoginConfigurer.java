...
import com.maoatao.cas.security.filter.ClientUserAuthenticationFilter;
 ...
 * 自定义 表单登陆配置
 * <p>
 * Customized by{@link FormLoginConfigurer}
 * <p>
 * {@link com.maoatao.cas.config.SecutityConfig}
 *
 * @author MaoAtao
 * @date 2023-03-12 20:50:01
 */
public class CustomFormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
    ...
    public CustomFormLoginConfigurer() {
        super(new ClientUserAuthenticationFilter(), null);
